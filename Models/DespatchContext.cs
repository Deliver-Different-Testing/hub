...
public partial class DespatchContext(DbContextOptions<DespatchContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ClientTypeFeature>(entity =>
        {
            ...
            entity.Property(e => e.Grantable)
                .HasDefaultValue(true)
                .HasAnnotation("Relational:DefaultConstraintName", "DF_ClientTypeFeature_Grantable");
        ...
        modelBuilder.Entity<TblFuelSurcharge>(entity =>
        {
            ...
            entity.Property(e => e.Active).HasAnnotation("Relational:DefaultConstraintName", "DF_tblFuelSurcharge_Active");
            entity.Property(e => e.ClientId).HasColumnName("ClientID");
            entity.Property(e => e.Created)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_tblFuelSurcharge_Created")
            ...
            entity.Property(e => e.LastModified)
                .HasDefaultValueSql("(getdate())")
                .HasAnnotation("Relational:DefaultConstraintName", "DF_tblFuelSurcharge_LastModified")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Rate)
                .HasAnnotation("Relational:DefaultConstraintName", "DF_tblFuelSurcharge_Rate")
                .HasColumnType("decimal(18, 4)");
            entity.Property(e => e.Start).HasColumnType("datetime");
            entity.Property(e => e.VehicleSizeId).HasColumnName("VehicleSizeID");

            entity.HasOne(d => d.Client).WithMany(p => p.TblFuelSurcharges)
                .HasForeignKey(d => d.ClientId)
                .HasConstraintName("FK_tblFuelSurcharge_tucClient");
        });
